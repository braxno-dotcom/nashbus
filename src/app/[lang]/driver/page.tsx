      ...
      <header className="sticky top-0 z-50 bg-slate-800 shadow-sm">
        <div className="max-w-2xl mx-auto flex items-center justify-between px-4 h-10">
          <div className="flex items-center gap-1.5">
            ...
            <a href={`${basePath}/${lang}/`} className="text-white font-bold text-sm hover:text-blue-200 transition-colors">
              NashBus
            </a>
          </div>
          <div className="flex items-center gap-1">
            <a
              ...
              className="text-white/70 hover:text-white px-2 py-1 rounded text-[10px] font-medium transition-colors"
            >
              {dict.nav.complaints}
            </a>
