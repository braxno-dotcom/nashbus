...
export default function DriverClients({ dict, driverId }: { dict: Dict; driverId: string }) {
  ...
  return (
    <div className="space-y-3">
      {/* Form */}
      <div className="bg-blue-50 rounded-lg border border-blue-100 shadow-sm p-3">
      ...
      {loadingClients ? (
        ...
        <div className="space-y-2">
          {clients.map((client) => (
            <div key={client.id} className="bg-blue-50 rounded-lg border border-blue-100 shadow-sm p-3">
              ...
              <button
                onClick={() => { setReceiptClient(client); setRouteFrom(""); setRouteTo(""); setRouteDate(""); setBusNumber(""); setRouteCities([]); }}
