            ...
            <form onSubmit={handleSubmit} className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input type="date" value={date} onChange={(e) => setDate(e.target.value)} required className="w-full px-2 py-2 rounded-lg bg-gray-50 border border-gray-200 text-xs focus:outline-none focus:border-blue-500" />
                </div>
